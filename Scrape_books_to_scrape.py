...
# Extrait la liste des url des catégories à partir du code de la page principales du site (soup) :
...
# Récupère la liste des catégories dans la page principales (soup)
list_categories_url = find_all_categories_url(soup)

# Execute le scripte "scrape_a_category" pour chaque catégorie
